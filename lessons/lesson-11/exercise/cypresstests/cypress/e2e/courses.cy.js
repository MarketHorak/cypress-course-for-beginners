...
describe('Courses tests', () => {
 ...
 //// Hodnota inputu se hned odesílá -> není co ověřit ...moc nechapu jak to
    course2.commentSection().should('contain','Advanced E2E Testing')
   ...
   // course3.addComment('3 necum snad se to vypise')
    course3.addCommentMoje('3 necum snad se to vypise')
    course3.clickButton()
